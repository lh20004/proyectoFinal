...
@WebServlet(name = "ReservacionesPagadasServlet", urlPatterns = {"/ReservacionesPagadasServlet"})
public class ReservacionesPagadasServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (filtro) {
            case "si_consulta":
                ...
                try {
                    ReservacionesPagadasDAO obaut = new ReservacionesPagadasDAO();
                    ...
                    for (Reserva objReservacion : listaReservaciones) {
                        System.out.println(objReservacion.getIdReserva());
                        cont++;
                        html += "<tr>";
                        html += "<td>" + objReservacion.getCliente().getNombre()+ "</td>";
                        html += "<td>" + objReservacion.getEstado()+ "</td>";                   
