...
import dao.ReservacionesPagadasDAO;
import dao.ServicioMasSolicitadoDAO;
...
@WebServlet(name = "ServicioMasSolicitadoServlet", urlPatterns = {"/ServicioMasSolicitadoServlet"})
public class ServicioMasSolicitadoServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (filtro) {
            case "si_consulta":
                ...
                try {
                    ServicioMasSolicitadoDAO obaut = new ServicioMasSolicitadoDAO();
                    ...
                    for (DetalleReserva objReservacion : listaReservaciones) {
                        System.out.println(objReservacion.getIdDetalle());
                        cont++;
                        html += "<tr>";
